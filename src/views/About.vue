		...
		<div class="grid">
			<div class="grid-items">
				...
				<a aria-label="link-2" target="_blank" rel="noopener" draggable="false" class="link w-inline-block">
					...
					<img class="content__img" src="https://images.pexels.com/photos/3540104/pexels-photo-3540104.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260" alt="img2"/>
				</a>
			</div>
		</div>
	</main>
...
export default {
  ...
  //   const effect = new RGBShiftEffect(container, itemsWrapper, { strength: 0.4 })
  // }
}
</script>
